...
public class DeleteProductController extends HttpServlet {
        ...
        String ERROR = "SearchProductController";
        String SUCCESS = "SearchProductController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            boolean check = shopdao.deleteProduct(productID);
            if(check){
                url=SUCCESS;
            }else{
                request.setAttribute("ERROR", "DELETE UNSUCCESSFUL");
            }
        }catch(Exception e){
